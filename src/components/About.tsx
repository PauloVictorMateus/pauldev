...
const About: React.FC = () => {
  return (
    <section id="about" className="min-h-screen bg-gray-100 dark:bg-gray-800 py-12 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row justify-between gap-8 max-w-7xl mx-auto">
        <div className="lg:w-1/2">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6 sm:mb-8">Sobre Mim</h2>
          <div className="bg-white dark:bg-gray-700 rounded-lg shadow-lg p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-center">
              ...
              <div className="flex-1 text-center sm:text-left">
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">Paulo Nascimento</h3>
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4">
                  Desenvolvedor Full Stack apaixonado por criar soluções web inovadoras.
                  Com experiência em React, TypeScript, e Nest.Js.
                </p>
                <div className="flex justify-center sm:justify-start gap-4">
                  ...
                  <div className="flex items-center gap-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-500 transition-colors">
                    <FaLinkedin />
                    <a href="https://www.linkedin.com/in/paulo-victor-dev/" 
                        target="_blank">
                      LinkedIn
                    </a>
                  </div>
            ...
            <div className="space-y-8">
              {timelineData.map((item, index) => (
                <div key={index} className="relative flex items-center">
                  ...
                  <div className="ml-6">
                    <h3 className="font-semibold text-gray-900 dark:text-white">{item.period}</h3>
